...
\item $|W| + |T| = |E|$.
\end{enumerate}
$\textbf{Proof:}$ Immediate from Rank Lemma (The maximal number of linearly independent tight constraints at an extreme point is equal to the number of edges). $\blacksquare$
\end{frame}
