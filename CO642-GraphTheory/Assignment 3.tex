...
\begin{align*}
p(R') &= (5 + \epsilon)|V(R')| - 3|E(R')| - \delta Y(R') \\
&= p_{KY}(R') + \epsilon |V(R')| - \delta Y(R') \\
&\leq p_{KY}(R) + p_{KY}(W) -P_{KY}(X) + \epsilon|V(R')| - \delta Y(R') &\text{ by Potential Extension Lemma}\\
&= p(R) - \epsilon|V(R)| + \delta Y(R) + p(W) - \epsilon|V(W)| + \delta Y(W) - (p(X) - \epsilon|V(X)| + \delta Y(X)) + \epsilon|V(R')| -\delta Y(R') \\
&= p(R) + p(W) - p(X) + \delta (Y(R) + Y(W) - Y(X)) - \epsilon(|V(R)| + |V(W)| - |V(X)|).
\end{align*}
\paragraph{}
Thus the result follows if we can show that $Y(R) + Y(W) - Y(X) \leq |X| \leq 4$.